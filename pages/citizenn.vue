    ...
    <div class="container">
        ...
        <div class="tableft">
            ...
            <ul class="tableft__list--options">
                ...
                <li class="tableft--option">
                    <nuxt-link to="/poli/seeInforCitizen/_seeInforCitizen" class="link">
                ...
                <li class="tableft--option manage--option">
                    ...
                    Quản lý thông tin
                    <svg class="manage__icon--arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512">
                        <path
                            d="M246.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-9.2-9.2-22.9-11.9-34.9-6.9s-19.8 16.6-19.8 29.6l0 256c0 12.9 7.8 24.6 19.8 29.6s25.7 2.2 34.9-6.9l128-128z" />
                    </svg>

                    <ul class="tableft__manage--options">
                        <nuxt-link to="/poli/addCitizen" class="link">
                            <li>Thêm tài khoản</li>
                        </nuxt-link>
                        <nuxt-link to="/poli/update" class="link">
                            <li>Cập nhật tài khoản</li>
                        </nuxt-link>
                    </ul>
                </li>
                <li class="tableft--option">
                    <nuxt-link to="/poli/requirement/_requirement" class="link">
                ...
                <li class="tableft--option">
                    <nuxt-link to="/poli/sendNotification/_sendNotification" class="link">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            <path
                ...
                <li class="tableft--option">
                    <nuxt-link to="/poli/appointment/_appointment" class="link">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            <path
            ...
            <nuxt-link to="/login">
                <div @click.prevent="logout" class="tableft-logout link">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path
...
.tableft--option:hover {
    background-color: #fff;
    color: #127E23;
}

.tableft--option:hover svg {
    fill: #127E23;
}

.tableft--option:hover .link {
    color: #127E23;
    font-weight: 550;
}
