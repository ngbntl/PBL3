                ...
                <li class="tableft--option manage--option">
                   ...
                   Xem thông tin
                    ...
                    <ul class="tableft__manage--options">
                        <nuxt-link to="/citizen/Family/Family_inf" class="link">
                            <li>Thông tin nhân thân</li>
                        </nuxt-link>
                        <nuxt-link to="/citizen/Leader" class="link">
                            <li>Thông tin cán bộ</li>
                        </nuxt-link>
                    </ul>
                </li>
                <li class="tableft--option">
                    <nuxt-link to="/citizen/GuiYC" class="link">
