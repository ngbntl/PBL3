<template>
  <div class="container">
    <h2>Danh sách lãnh đạo tại {{ this.level }} {{ this.nameArea }}</h2>
    <div class="form" @submit.prevent="searchInforCitizen">
      <input v-model="idSearch" class="input-search" type="text">
      <svg class="icon-glass" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path
